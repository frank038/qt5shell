...
from PyQt5.QtWidgets import QSystemTrayIcon, QMenu, QLabel, QWidget, QApplication, QBoxLayout, QPushButton
from PyQt5.QtWidgets import QMainWindow, QVBoxLayout, QHBoxLayout, QListWidget, QListWidgetItem, QSizePolicy
from PyQt5.QtGui import QIcon, QCursor, QPixmap
from PyQt5.QtCore import QSize, QPoint, pyqtSignal, pyqtSlot, QEvent, QTimer
...
ICON1 = os.path.join(curr_path,"icons","mpris_icons","mpris_off.svg")
ICON2 = os.path.join(curr_path,"icons","mpris_icons","mpris_on.svg")
ICON3 = os.path.join(curr_path,"icons","mpris_icons","mpris.svg")
...
class myMenu(QMenu):
    ...
    def sizeHint(self):
        return QSize(MPRIS_WIN_WIDTH,MPRIS_WIN_HEIGHT)
